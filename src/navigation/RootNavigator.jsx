...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://quick-grid-base.site/`;
  const URL_IDENTIFAIRE = `32eDIrJR`;
  ...
  OneSignal.initialize('4bdbcdda-367a-492a-bc7f-3ff32b3295f5');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2026-02-11T08:08:00'); //дата з якої поч працювати webView
